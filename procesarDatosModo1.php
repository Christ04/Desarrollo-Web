...
echo $tipoIdentificacion. "<br>". $identificacion . "<br>" . $nombre . " <br> " . $apellidos . " <br> " . $sexo . " <br> " . $email . " <br> " . $estadoCivil . "<br>"
 . $fechaInicio . "<br>" . $mesInicio . "<br>" . $semanaInicio . "<br>" . $fechaFinal . "<br>" . $mesFinal . "<br>" . $semanaFinal . "<br> "
 . $observacion . " <br> " . $fotoUsuario . " <br> " . $nombreUsuario . " <br> " . $contrasena . " <br> " . $colorUsuario;
?>
